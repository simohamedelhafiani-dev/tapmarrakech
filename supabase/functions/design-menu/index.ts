...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      'Les sections doivent référencer les vrais category_id et item_ids fournis.',
      'Ne crée pas de section vide.',
      'Pour featured, sélectionne uniquement des produits réellement présents et mets au maximum 4 item_ids.',
      'Pour category, utilise la catégorie correspondante et tous les produits de cette catégorie ou un sous-ensemble pertinent.',
